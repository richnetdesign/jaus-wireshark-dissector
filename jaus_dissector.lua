...
-- 2021 Jan 31, Rich Young.  Updated to work with Wireshark 3.4
...
local jaus_proto = Proto("JAUS","Jaus Protocol")

local MessageIDs = { [0x2B00] = "QueryIdentification", [0x2B01] = "QueryConfiguration", [0x2B02] = "QuerySubsystemList"}
